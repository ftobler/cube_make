...
def stm32_project_path(tmp_path):
    ...
    with open("tests/stm32_cproject_fixture.xml", "r") as f:
        cproject_content = f.read()

    (project_dir / ".cproject").write_text(cproject_content)
    ...
    (project_dir / "Drivers" / "STM32G0xx_HAL_Driver" / "Inc" / "stm32g0xx_hal.h").write_text("#define HAL_H")
...
# --- Tests for Tooling Availability ---
